...
FULL_URL =  BASE_INDEED_URL + "/jobs" + "?" + JOBTITLE_PARAM + "&" + LOCATION_PARAM + "&fromage=29&limit=100"
...
url_list = IndeedUtils::create_url_array(job_listing_nodeset, TITLE_BLACK_LIST).compact # Remove Nil's
p url_list.count
...
url_list.each do |url|
  ...
  begin
    ...
    columns_arr = IndeedUtils::extract_data_from_indeed(content, local_fname, job_description_url, 1)
